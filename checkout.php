                ...
                <div class="row">
		                ...
		                <?php if($checkout_access == 0): ?>
		                	<div class="col-md-12">
                                ...
                                Vous devez remplir toutes les informations de facturation et de livraison depuis votre panneau de contrôle pour finaliser la commande. Veuillez remplir les informations en vous rendant sur <a href="customer-billing-shipping-update.php" style="color:red;text-decoration:underline;">ce lien</a>.
			                    </div>
	                    	</div>
	                	<?php else: ?>
		                	<div class="col-md-4">
