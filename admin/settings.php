...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Le logo a été mis à jour avec succès.';
...
if(isset($_POST['form2'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Le favicon a été mis à jour avec succès.';
...
if(isset($_POST['form3'])) {
    ...
    $success_message = 'Les paramètres du contenu général ont été mis à jour avec succès.';
...
if(isset($_POST['form4'])) {
    ...
    $success_message = 'Les informations des paramètres du formulaire de contact ont été mises à jour avec succès.';
}
...
if(isset($_POST['form6_0'])) {
    ...
    $success_message = 'Les paramètres de la section On-Off ont été mis à jour avec succès.';
}
...
if(isset($_POST['form6'])) {
    ...
    $success_message = 'Les paramètres des métadonnées de la page d accueil ont été mis à jour avec succès.';
}
...
if(isset($_POST['form6_7'])) {
    ...
    if(empty($_POST['cta_read_more_text'])) {
        $valid = 0;
        $error_message .= 'Le texte "Lire la suite" de l appel à l action ne peut pas être vide.<br>';
    }

    if(empty($_POST['cta_read_more_url'])) {
        $valid = 0;
        $error_message .= 'URL "Lire la suite" de l appel à l action ne peut pas être vide.<br>';
    }
    ...
    if($valid == 1) {
        ...
        $success_message = 'Les données de l appel à l action ont été mises à jour avec succès.';
...
if(isset($_POST['form6_4'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Les données du produit en vedette ont été mises à jour avec succès.';
...
if(isset($_POST['form6_5'])) {
    ...
    if(empty($_POST['latest_product_title'])) {
        $valid = 0;
        $error_message .= 'Le titre du produit le plus récent ne peut pas être vide.<br>';
    }

    if(empty($_POST['latest_product_subtitle'])) {
        $valid = 0;
        $error_message .= 'Le sous-titre du produit le plus récent ne peut pas être vide.<br>';
    }
    ...
    if($valid == 1) {
        ...
        $success_message = 'Les données du produit le plus récent ont été mises à jour avec succès.';
...
if(isset($_POST['form6_6'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Les données du produit populaire ont été mises à jour avec succès.';
...
if(isset($_POST['form6_3'])) {
        ...
        $success_message = 'Le texte de la newsletter a été mis à jour avec succès.';
...
if(isset($_POST['form7_1'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'La bannière de la page de connexion a été mise à jour avec succès.';
...
if(isset($_POST['form7_2'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'La bannière de la page d inscription a été mise à jour avec succès.';
...
if(isset($_POST['form7_3'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'La bannière de la page "Mot de passe oublié" a été mise à jour avec succès.';
...
if(isset($_POST['form7_4'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'La bannière de la page de réinitialisation du mot de passe a été mise à jour avec succès.';
...
if(isset($_POST['form7_6'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'La bannière de la page de recherche a été mise à jour avec succès.';
...
if(isset($_POST['form7_7'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'La bannière de la page du panier a été mise à jour avec succès.';
...
if(isset($_POST['form7_8'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'La bannière de la page de paiement a été mise à jour avec succès.';
...
if(isset($_POST['form7_9'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'La bannière de la page de catégorie de produit a été mise à jour avec succès.';
...
if(isset($_POST['form10'])) {
    ...
    $success_message = 'Les scripts de l en-tête et du corps ont été mis à jour avec succès.';
}
        ...
        <div class="col-md-12">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#tab_3" data-toggle="tab">Pied de page & Contact</a></li>
                        <li><a href="#tab_4" data-toggle="tab">Paramètres des messages</a></li>
                        <li><a href="#tab_5" data-toggle="tab">Produits</a></li>
                        <li><a href="#tab_6" data-toggle="tab">Paramètres de la page d'accueil</a></li>
                        ...
                        <li><a href="#tab_10" data-toggle="tab">Scripts dans l'en-tête et le corps</a></li>
                    ...
                    <div class="tab-content">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form1">Mettre à jour le logo</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form2">metre à jour Favicon</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="tab_3">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Section de la newsletter </label>
                                        <div class="col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Pieds de page - Copyright </label>
                                        <div class="col-sm-9">
                                            <input class="form-control" type="text" name="footer_copyright" value="<?php echo $footer_copyright; ?>">
                                        </div>
                                    </div>                              
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Contact Adresse </label>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Contact numero tel</label>
                                        <div class="col-sm-6">
                        ...
                        <div class="tab-pane" id="tab_4">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Contact Email Adresse</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="receive_email" value="<?php echo $receive_email; ?>">
                                        </div>
                                    </div>                                  
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Contact Email Sujet</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="receive_email_subject" value="<?php echo $receive_email_subject; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Message de remerciement pour l'email de contact</label>
                                        <div class="col-sm-8">
                                            <textarea class="form-control" name="receive_email_thank_you_message"><?php echo $receive_email_thank_you_message; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Message de mot de passe oublié</label>
                                        <div class="col-sm-8">
                        ...
                        <div class="tab-pane" id="tab_5">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-4 control-label">Page d'accueil (Combien de produits en vedette ?)<span>*</span></label>
                                        <div class="col-sm-2">
                                            <input type="text" class="form-control" name="total_featured_product_home" value="<?php echo $total_featured_product_home; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-4 control-label">Page d'accueil (Combien de produits récents ?)<span>*</span></label>
                                        <div class="col-sm-2">
                                            <input type="text" class="form-control" name="total_latest_product_home" value="<?php echo $total_latest_product_home; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-4 control-label">Page d'accueil (Combien de produits populaires ?)<span>*</span></label>
                                        <div class="col-sm-2">
                        ...
                        <div class="tab-pane" id="tab_6">
                        	...
                        	<h3>Sections activées et désactivées</h3>
                            <form class="form-horizontal" action="" method="post">
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Section des services </label>
                                        <div class="col-sm-4">
                                            <select name="home_service_on_off" class="form-control" style="width:auto;">
                                            	<option value="1" <?php if($home_service_on_off == 1) {echo 'selected';} ?>>Activé</option>
                                            	<option value="0" <?php if($home_service_on_off == 0) {echo 'selected';} ?>>Desactivé</option>
                                            </select>
                                        </div>
                                    </div>      
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Section de bienvenue</label>
                                        <div class="col-sm-4">
                                            <select name="home_welcome_on_off" class="form-control" style="width:auto;">
                                            	<option value="1" <?php if($home_welcome_on_off == 1) {echo 'selected';} ?>>Activé</option>
                                            	<option value="0" <?php if($home_welcome_on_off == 0) {echo 'selected';} ?>>Desactivé</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <select name="home_featured_product_on_off" class="form-control" style="width:auto;">
                                            	<option value="1" <?php if($home_featured_product_on_off == 1) {echo 'selected';} ?>>Activé</option>
                                            	<option value="0" <?php if($home_featured_product_on_off == 0) {echo 'selected';} ?>>Désactivé</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Section des produits récents </label>
                                        <div class="col-sm-4">
                                            <select name="home_latest_product_on_off" class="form-control" style="width:auto;">
                                            	<option value="1" <?php if($home_latest_product_on_off == 1) {echo 'selected';} ?>>Activé</option>
                                            	<option value="0" <?php if($home_latest_product_on_off == 0) {echo 'selected';} ?>>Désactivé</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Section des produits populaires </label>
                                        <div class="col-sm-4">
                                            <select name="home_popular_product_on_off" class="form-control" style="width:auto;">
                                            	<option value="1" <?php if($home_popular_product_on_off == 1) {echo 'selected';} ?>>Activé</option>
                                            	<option value="0" <?php if($home_popular_product_on_off == 0) {echo 'selected';} ?>>Désactivé</option>
                                            </select>
                                        </div>
                                    </div>
                                   <!-- <div class="form-group">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Titre meta </label>
                                        <div class="col-sm-8">
                           ...
                           <!-- <h3>Call to Action Section</h3>
                            ...
                            <h3>Section des produits phares</h3>
                            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="box box-info">
                                <div class="box-body">                                          
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Titre des produits en vedette<span>*</span></label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="featured_product_title" value="<?php echo $featured_product_title; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Sous-titre des produits en vedette<span>*</span></label>
                                        <div class="col-sm-8">
                            ...
                            <h3>Section des produits récents</h3>
                            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="box box-info">
                                <div class="box-body">                                          
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Titre des produits récents<span>*</span></label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="latest_product_title" value="<?php echo $latest_product_title; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Sous-titre des produits récents<span>*</span></label>
                                        <div class="col-sm-8">
                            ...
                            <h3>Section des produits populaires</h3>
                            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="box box-info">
                                <div class="box-body">                                          
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Titre des produits populaires<span>*</span></label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="popular_product_title" value="<?php echo $popular_product_title; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Sous-titre des produits populaires<span>*</span></label>
                                        <div class="col-sm-8">
                            ...
                            <h3>Section de la newsletter</h3>
                            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="box box-info">
                                <div class="box-body">                                          
                                    <div class="form-group">
                        ...
                        <div class="tab-pane" id="tab_7">
                            ...
                            <table class="table table-bordered">
                                <tr>
                                    ...
                                    <td style="width:50%">
                                        <h4>Bannière de la page de connexion existante</h4>
                                        <p>
                                            <img src="<?php echo '../assets/uploads/'.$banner_login; ?>" alt="" style="width: 100%;height:auto;"> 
                                        </p>                                        
                                    </td>
                                    <td style="width:50%">
                                        <h4>Changer la bannière de la page de connexion</h4>
                                        Sélectionner une photo<input type="file" name="photo">
                                ...
                                <tr>
                                    ...
                                    <td style="width:50%">
                                        <h4>Changer la bannière de la page d'inscription</h4>
                                        Sélectionner une photo<input type="file" name="photo">
                                ...
                                <tr>
                                    <form action="" method="post" enctype="multipart/form-data">
                                    <td style="width:50%">
                                        <h4>Bannière de la page de mot de passe oublié existante</h4>
                                        <p>
                                            <img src="<?php echo '../assets/uploads/'.$banner_forget_password; ?>" alt="" style="width: 100%;height:auto;">   
                                        </p>                                        
                                    </td>
                                    <td style="width:50%">
                                        <h4>Changer la bannière de la page de mot de passe oublié</h4>
                                        Sélectionner une photo<input type="file" name="photo">
                                ...
                                <tr>
                                    ...
                                    <td style="width:50%">
                                        <h4>Changer la bannière de la page de réinitialisation du mot de passe</h4>
                                        Sélectionner une photo<input type="file" name="photo">
                                ...
                                <tr>
                                    <form action="" method="post" enctype="multipart/form-data">
                                    <td style="width:50%">
                                        <h4>Bannière de la page de recherche existante</h4>
                                        <p>
                                            <img src="<?php echo '../assets/uploads/'.$banner_search; ?>" alt="" style="width: 100%;height:auto;">  
                                        </p>                                        
                                    </td>
                                    <td style="width:50%">
                                        <h4>Changer la bannière de la page de recherche</h4>
                                ...
                                <tr>
                                    <form action="" method="post" enctype="multipart/form-data">
                                    <td style="width:50%">
                                        <h4>Bannière de la page du panier existante</h4>
                                        <p>
                                            <img src="<?php echo '../assets/uploads/'.$banner_cart; ?>" alt="" style="width: 100%;height:auto;">  
                                        </p>                                        
                                    </td>
                                    <td style="width:50%">
                                        <h4>Changer la bannière de la page du panier</h4>
                                        Sélectionner une photo<input type="file" name="photo">
                                ...
                                <tr>
                                    <form action="" method="post" enctype="multipart/form-data">
                                    <td style="width:50%">
                                        <h4>Bannière de la page de paiement existante</h4>
                                        <p>
                                            <img src="<?php echo '../assets/uploads/'.$banner_checkout; ?>" alt="" style="width: 100%;height:auto;">  
                                        </p>                                        
                                    </td>
                                    <td style="width:50%">
                                        <h4>Changer la bannière de la page de paiement</h4>
                                        Sélectionner une photo<input type="file" name="photo">
                                ...
                                <tr>
                                    <form action="" method="post" enctype="multipart/form-data">
                                    <td style="width:50%">
                                        <h4>Bannière de la page de catégorie de produit existante</h4>
                                        <p>
                                            <img src="<?php echo '../assets/uploads/'.$banner_product_category; ?>" alt="" style="width: 100%;height:auto;">  
                                        </p>                                        
                                    </td>
                                    <td style="width:50%">
                                        <h4>Changer la bannière de la page de catégorie de produit</h4>
                                        Sélectionner une photo<input type="file" name="photo">
                        ...
                        <div class="tab-pane" id="tab_9">
                            <form class="form-horizontal" action="" method="post">
                                <div class="box box-info">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label">PayPal - Email professionnel </label>
                                            <div class="col-sm-5">
