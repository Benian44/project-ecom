...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['tcat_name'])) {
        $valid = 0;
        $error_message .= "Le nom de la catégorie principale ne peut pas être vide.<br>";
    } else {
    	...
    	if($total) {
    		$valid = 0;
        	$error_message .= 'Le nom de la catégorie principale existe déjà.<br>';
    	}
    }
    ...
    if($valid == 1) {    	
    	...
    	$success_message = 'La catégorie principale a été mise à jour avec succès.';
    }
}
?>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Modifier la catégorie principale</h1>
	</div>
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">Nom de la catégorie principale <span>*</span></label>
                    <div class="col-sm-4">
