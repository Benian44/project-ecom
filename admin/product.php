    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p style="color:red;">Attention ! Ce produit sera supprimé de la table des commandes, de la table des paiements, de la table des tailles, de la table des couleurs et de la table des évaluations.</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Annueler</button>
