...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['country_id'])) {
    	...
    	if($total) {
    		$valid = 0;
        	$error_message .= 'Le pays existe déjà.<br>';
    	}
    }
    ...
    if($valid == 1) {    	
    	...
    	$success_message = 'Les frais d expédition ont été mis à jour avec succès';
    }
}
?>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Modifier les frais d'expédition.</h1>
	</div>
            ...
            <div class="box box-info">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <button type="submit" class="btn btn-success pull-left" name="form1">Metre à jour</button>
                        </div>
                    </div>
                </div>
            </div>
