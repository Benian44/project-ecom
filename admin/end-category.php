...
<section class="content-header">
	<div class="content-header-left">
		<h1>Voir les catégories de niveau final.</h1>
	</div>
	<div class="content-header-right">
		<a href="end-category-add.php" class="btn btn-primary btn-sm">Ajouter une nouvelle</a>
	</div>
</section>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p style="color:red;">Attention ! Tous les produits sous cette catégorie de niveau final seront supprimés de toutes les tables, telles que la table des commandes, la table des paiements, la table des tailles, la table des couleurs, la table des évaluations, etc.</p>
            </div>
