...
if(isset($_POST['form_about'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Les informations de la page À propos ont été mises à jour avec succès.';
...
if(isset($_POST['form_contact'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Les informations de la page Contact ont été mises à jour avec succès.';
                        ...
                        <div class="tab-pane active" id="tab_1">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Meta Titre</label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form_about">Mettre à Jour</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <!-- FAQ Page Content -->
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form_faq">Mettre à jour</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="tab_4">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Page Titre * </label>
                                        <div class="col-sm-5">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form_contact">Mettre à jour</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
