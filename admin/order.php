    ...
    if($valid == 1) {
        ...
        foreach ($result as $row) {
        	...
        	if($row['payment_method'] == 'PayPal'):
        		$payment_details = '
ID de la transaction : '.$row['txnid'].'<br>
        		';
        	elseif($row['payment_method'] == 'Stripe'):
				$payment_details = '
ID de la transaction : '.$row['txnid'].'<br>
Numéro de carte : '.$row['card_number'].'<br>
CVV de la carte : '.$row['card_cvv'].'<br>
...
Email du client : '.$row['customer_email'].'<br>
Méthode de paiement : '.$row['payment_method'].'<br>
Date de paiement : '.$row['payment_date'].'<br>
Détails du paiement : <br>'.$payment_details.'<br>
Montant payé : '.$row['paid_amount'].'<br>
Statut du paiement : '.$row['payment_status'].'<br>
Statut de l\'expédition : '.$row['shipping_status'].'<br>
ID de paiement : '.$row['payment_id'].'<br>
            ';
        }
...
';
        ...
        $success_message = 'Votre email au client a été envoyé avec succès.';
					...
					<tr class="<?php if($row['payment_status']=='Pending'){echo 'bg-r';}else{echo 'bg-g';} ?>">
								...
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											...
											<h4 class="modal-title" style="font-weight: bold;">Envoyer le message</h4>
										</div>
                        ...
                        <td>
                        	...
                        	<?php elseif($row['payment_method'] == 'Stripe'): ?>
                        		...
                        		<b>CVV de la carte :</b> <?php echo $row['card_cvv']; ?><br>
                        	...
                        	<?php elseif($row['payment_method'] == 'Bank Deposit'): ?>
                        		...
                        		<b>ID de paiement :</b> <?php echo $row['payment_id']; ?><br>
								<b>Date:</b> <?php echo $row['payment_date']; ?><br>
                        		<b>Informations sur la transaction :</b> <br><?php echo $row['bank_transaction_info']; ?><br>
                        	<?php endif; ?>
                        </td>
