...
if(isset($_POST['form1'])) {
    ...
    if($_POST['amount'] == '') {
        ...
        if(!is_numeric($_POST['amount'])) {
            $valid = 0;
            $error_message .= 'Vous devez entrer un numéro valide.<br>';
        }
    }
    ...
    if($valid == 1) {
        ...
        $success_message = 'Le coût de la livraison a été ajouté avec succès.';
    }
...
if(isset($_POST['form2'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Le coût d expédition pour le reste du monde a été mis à jour avec succès.';
...
<section class="content-header">
    <div class="content-header-left">
        <h1>Ajouter les frais d'expédition.</h1>
    </div>
</section>
                ...
                <div class="box box-info">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">Sélectionner un pays <span>*</span></label>
                            <div class="col-sm-4">
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Afficher les frais d'expédition.</h1>
	</div>
</section>
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <h4 style="background: #dd4b39;color:#fff;padding:10px 20px;">NB : Si un pays n'existe pas dans la liste ci-dessus, les frais d'expédition pour le "Reste du monde" seront appliqués.</h4>
                ...
                <div class="box box-info">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label"></label>
                            <div class="col-sm-6">
                                <button type="submit" class="btn btn-success pull-left" name="form2">Metre à jour</button>
                            </div>
                        </div>
                    </div>
                </div>
