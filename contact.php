...
?>
                ...
                ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" name="visitor_email" placeholder="Entrer votre email">
                                    </div>
                                    <div class="form-group">
                                        <label for="email">Numero de tel</label>
                                        <input type="text" class="form-control" name="visitor_phone" placeholder="Entrer votre numero">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name">Message</label>
                                        <textarea name="visitor_message" class="form-control" rows="9" cols="25" placeholder="Entrer votre message"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                        ...
                        <address>
                            <strong>Numero de tel:</strong><br>
