...
if(isset($_POST['form1'])) {
    ...
    $error_message .= '\La quantité des autres articles a été mise à jour avec succès !';
    ?>
    
    <?php if($allow_update == 0): ?>
    	<script>alert('<?php echo $error_message; ?>');</script>
	<?php else: ?>
		<script>alert('La mise à jour de la quantité de tous les articles a été réussie !');</script>
	<?php endif; ?>
    <?php
		...
		<div class="row">
			<div class="col-md-12">
                ...
                <?php if(!isset($_SESSION['cart_p_id'])): ?>
                    ...
                    <?php echo '<h4 class="text-center">Ajoutez des produits au panier pour les voir ici.</h4>'; ?>
                <?php else: ?>
